...
public class Stopwords {
	...
	public static String[] stopwords = { "cả_thảy", "biết_đâu_chừng",
			...
			"dầu_sao", "bây_nhiêu", "ờ", "rằng", "ở", "cho_biết", "t_và",
			"tiếp_đó", "nghỉ", "quá_trời", "ừ", "ử", "qua_quýt", "tăm_tắp",
			"ngọt", "chầm_chập", "pupu", "úi_chà", "chỉ", "tênh", "dẫu_sao",
			"chỉ_do", "chớ", "ngày", "chứ", "và", "chẳng", "vì", "cóc_khô",
			"ngừng", "quá", "củng", "riệt", "đứng", "các", "đóng", "thực_sự",
			"cái", "tuốt_luốt", "sắp", "cứ_việc", "muốn", "vượt", "vì_chưng",
			...
			"viết", "đại_nhân", "thẳng", "đừng", "kiểu", "bị_chú", "chung",
			"nghe_chừng", "cao", "thấy", "để", "bất_giác", "bởi_nhưng",
			"dù_rằng", "bất_đồ", "khóa", "khoa", "với", "phỉ_phui", "tắp_lự",
			"hoặc", "rồi", "chính_vì", "buổi", "lời", "ta", "không", "mọi",
			"thiệt", "suy_nghĩ", "bên", "lúc", "nữ", "nay", "mấy", "nha", "st",
			"làm_gì", "nè", "hai", "tư", "bốn", "hôm_qua", "inb", "dk", "hãy",
			"hóa", "hướng", "vực", "dậy", "òi", "kuto" };
